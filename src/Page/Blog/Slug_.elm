...
view maybeUrl sharedModel static =
    ...
    , body =
        [ Element.el [ width fill, Element.htmlAttribute (Attrs.class "responsive-mobile") ]
            (if RenderConfig.isPortrait sharedModel.window then
                viewMobile static
...
head static =
    ...
    Head.structuredData
        (StructuredData.article
            ...
            , author = StructuredData.person { name = Author.union.name }
            , publisher = StructuredData.person { name = Author.union.name }
